...
export const ERASER_ITEM_TYPE = "eraser";

export const itemBuilder = (item: EraserItemType, id?: string) =>
  new EraserItem(item, id);

export interface EraserItemOptions {
  color: string;
  size: number;
  smoothing?: number;
  thinning?: number;
...
/**
 * Type for a eraser item.
 */
export interface EraserItemType extends WhiteboardItemType {
  path: { x: number; y: number }[];
  options: EraserItemOptions;
}

/**
 * Class for a eraser item.
 */
export class EraserItem extends WhiteboardItem<EraserItemType> {
  private path: { x: number; y: number }[];
  private options: EraserItemOptions;

  constructor(item: EraserItemType, id?: string) {
    super(item, id);
  ...
  public override getType(): string {
    return ERASER_ITEM_TYPE;
  }

  /**
   * Export the eraser item to a JSON object.
   *
   * @returns The exported eraser item.
   */
  public override export(): ExportedWhiteboardItem<EraserItemType> {
    return {
      id: this.getId(),
      type: this.getType(),
      data: {
   ...
   */
  public override partialUpdate(item: Partial<EraserItemType>): void {
   ...
   */
  public override update(item: EraserItemType): void {
    this.path = item.path;
    this.options = item.options;
  }

  /**
   * Draw the eraser item.
   *
  ...
  public override draw(context: DrawingContext): void {
    ...
    const optionsOverride: Partial<EraserItemOptions> = {};
   ...
   */
  public getOptions(): EraserItemOptions {
    return this.options;
  }
   ...
   */
  public setOptions(options: EraserItemOptions): void {
   ...
   */
  public updateOptions(options: Partial<EraserItemOptions>): void {
    this.options = {
      ...this.options,
      ...options,
    };
